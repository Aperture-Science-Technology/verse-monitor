var I18N = (function(){
  ...
  var dict = {
    ...
    'reg.step2Hint':   { fr: 'Discord, Slack, Telegram Bot API, ou tout endpoint HTTPS acceptant des JSON POST.', en: 'Discord, Slack, Telegram Bot API, or any HTTPS endpoint that accepts JSON POST.' },
